...
//        driver.get("https://practicetestautomation.com/practice-test-login/");
    ...
    public void the_user_enters_a_valid_username_and_password() {
        ...
        testContextUI.getDriver().findElement(By.id("username")).sendKeys("student");
        testContextUI.getDriver().findElement(By.id("password")).sendKeys("Password123");
    }
    ...
    public void the_user_enters_a_valid_username_and_password_outline(String username, String password) {
        System.out.println("the user enters a valid username and password");
        testContextUI.getDriver().findElement(By.id("username")).sendKeys(username);
    ...
    public void the_user_should_be_logged_in_successfully() {
        ...
        String currentUrl = testContextUI.getDriver().getCurrentUrl();
    ...
    public void the_user_click_on_submit_button() {
        ...
        testContextUI.getDriver().findElement(By.id("submit")).click();
    }
}
